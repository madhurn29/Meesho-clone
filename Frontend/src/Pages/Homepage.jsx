      ...
      <Box>
        ...
        <Flex width="80%" margin={"auto"}>
          <Divider
            ...
            m="auto"
          />
          <Text fontSize={{ base: "9px", lg: "36px" }} fontWeight={600}>
        ...
        <Flex
          ...
          mb={"50px"}
          backgroundImage={
            "https://images.meesho.com/images/marketing/1678691670429.jpg"
          }
        >
          <Box mt={"5%"}>
            <Image
              src={
                "https://images.meesho.com/images/marketing/1678691686252.webp"
              }
            />
          </Box>
          <Box mt={"16%"}>
            <Image
              src={
                "https://images.meesho.com/images/marketing/1678691699680.webp"
              }
            />
          </Box>
          <Box mt={"16%"}>
            <Image
              src={
                "https://images.meesho.com/images/marketing/1678691712594.webp"
              }
            />
          </Box>
        </Flex>
        ...
        <Flex
          ...
          mb={"50px"}
          backgroundImage={
            "	https://images.meesho.com/images/marketing/1678691743015.jpg"
          }
        >
          <Box mt={"6%"}>
            <Image
              src={
                "https://images.meesho.com/images/marketing/1678691846068.webp"
              }
            />
            <Text
          ...
          <Box mt={"6%"}>
            <Image
              src={
                "https://images.meesho.com/images/marketing/1678691832099.webp"
              }
            />
            <Text
              fontSize={{ base: "10px", lg: "18px" }}
          ...
          <Box mt={"6%"}>
            <Image
              src={
                "https://images.meesho.com/images/marketing/1678691796046.webp"
              }
            />
            <Text
              fontSize={{ base: "10px", lg: "18px" }}
        ...
        <Flex
          ...
          mb={"50px"}
          backgroundImage={
            "https://images.meesho.com/images/marketing/1678691892265.jpg"
          }
        >
          <Box mt={"6%"}>
            <Image
              src={
                "https://images.meesho.com/images/marketing/1678691960553.webp"
              }
            />
            <Text
              fontSize={{ base: "10px", lg: "18px" }}
          ...
          <Box mt={"6%"}>
            <Image
              src={
                "https://images.meesho.com/images/marketing/1678691936892.webp"
              }
            />
            <Text
              fontSize={{ base: "10px", lg: "18px" }}
          ...
          <Box mt={"6%"}>
            <Image
              src={
                "https://images.meesho.com/images/marketing/1678691925419.webp"
              }
            />
            <Text
              fontSize={{ base: "10px", lg: "18px" }}
        ...
        <Box width="90%" m="auto" mt="5%">
          <Text fontSize={{ base: "20px", lg: "32px" }} fontWeight={700}>
            Products For You
          </Text>
          <Flex gap="20px">
            {/* sidebar */}
                  ...
                  <AccordionItem marginTop="20px">
                    ...
                    <AccordionPanel pb={4}>
                      ...
                      <Stack spacing={5} direction="column">
                        <Checkbox colorScheme="green">Analog Watches</Checkbox>
                        ...
                        <Checkbox colorScheme="green">Bedsheets</Checkbox>

                        <Checkbox colorScheme="green">Ayurvedic</Checkbox>
                      </Stack>
                    </AccordionPanel>
                  </AccordionItem>
            ...
            >
              {filterdata.length > 0
                      ...
                      <Box mt="10px">
                        ...
                        >
                          <Text
                            ...
                            w="70px"
                            bgColor={
                              item.rating > 3.6 ? "rgb(35,187,117)" : "orange"
                            }
                            color="white"
                          >
                            {item.rating}{" "}
                            <span>
                              <StarIcon fontSize={"17px"} />{" "}
                            </span>{" "}
                          </Text>
                          <Text padding={"5px"} fontSize={"15px"}>
                            {item.review}
                          </Text>
                        </Flex>
                      </Box>
                ...
                : data.map((item) => (
                    ...
                    >
                      <Image
                        width={{ base: "150px", md: "240px", lg: "250px" }}
                        height={{ base: "200px", md: "200px", lg: "250px" }}
                        margin={"auto"}
                        src={item.images[0]}
                      />
