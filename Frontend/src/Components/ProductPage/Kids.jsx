...
export const Kids = () => {
    ...
    const handleCategoryPrice = (event) => {
      console.log("priceasd:")
      const price = event.target.value;
      setFilterPrice(price);
      if (price === 'All') {
        setPro(pro);
      } else {
        const filteredProducts = pro.filter(product => product.price < price);
    ...
    useEffect(()=>{
      setLoad(true)
        axios.get("https://long-lime-fly-tux.cyclic.app/products?category=kids").then((res)=>{
...
<Accordion fontSize="10px" fontWeight={400} lineHeight='24px' color=' rgb(102, 102, 102)' border="1px solid rgb(240,240,240)" padding={"20px"} allowMultiple>
    ...
    <AccordionItem marginTop="20px">
        ...
        <AccordionPanel pb={4}>
            ...
            <Select value={filterPrice} onChange={handleCategoryPrice}>
            <option value="All">All</option>
                <option value="Under ₹ 199">Under ₹ 199</option>
                <option value="Under ₹ 399">Under ₹ 399</option>
                <option value="Under ₹ 599">Under ₹ 599</option>
                <option value="Under ₹ 799">Under ₹ 799</option>
